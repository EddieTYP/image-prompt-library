...
export interface GenerationProviderStatus { provider: string; display_name: string; auth_mode?: string; optional: boolean; configured: boolean; authenticated: boolean; available: boolean; state: string; status?: 'ready' | 'unavailable' | 'login_required' | 'auth_error'; message?: string | null; can_generate?: boolean; reason?: string | null; features: GenerationProviderFeatures; token_present?: boolean; key_present?: boolean; credential_source?: 'environment' | 'local_store' | null; managed_by_environment?: boolean; account_id?: string | null; auth_store_path?: string; orchestrator_models?: string[]; default_orchestrator_model?: string; image_models?: string[]; default_image_model?: string; quality_options?: string[]; default_quality?: string; max_input_images?: number; retention_days?: number; supports_zero_data_retention?: boolean }
