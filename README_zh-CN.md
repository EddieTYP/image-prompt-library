...
当前公开 beta：[`v0.7.1-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.1-beta)。这个版本加入搜索排序 operators、在工作 queue 显示 Cancel，并在 backend restart 后把中断的 running generation jobs 标记为 failed。
