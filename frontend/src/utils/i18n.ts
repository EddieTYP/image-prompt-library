...
const TRANSLATIONS: Record<UiLanguage, Record<TranslationKey, string>> = {
  zh_hant: {
    ...
    deleteReference: '刪除參考', deleteReferenceConfirm: '刪除此參考？Library 記錄及未被其他參考使用的本機圖片檔案會被刪除。', selectReferences: '選取', selectedReferences: '已選取', deleteSelectedReferences: '刪除', deleteSelectedReferencesConfirm: '刪除已選取參考？Library 記錄及未被其他參考使用的本機圖片檔案會被刪除。', cancel: '取消', saving: '儲存中…', saveReference: '儲存參考', saveFailed: '儲存失敗，請再試一次。',
  ...
  zh_hans: {
    ...
    deleteReference: '删除参考', deleteReferenceConfirm: '删除此参考？Library 记录及未被其他参考使用的本地图片文件会被删除。', selectReferences: '选择', selectedReferences: '已选择', deleteSelectedReferences: '删除', deleteSelectedReferencesConfirm: '删除已选择参考？Library 记录及未被其他参考使用的本地图片文件会被删除。', cancel: '取消', saving: '保存中…', saveReference: '保存参考', saveFailed: '保存失败，请再试一次。',
  ...
  en: {
    ...
    deleteReference: 'Delete reference', deleteReferenceConfirm: 'Delete this reference? The library record and local image files not used by another reference will be deleted.', selectReferences: 'Select', selectedReferences: 'selected', deleteSelectedReferences: 'Delete', deleteSelectedReferencesConfirm: 'Delete selected references? Library records and local image files not used by another reference will be deleted.', cancel: 'Cancel', saving: 'Saving…', saveReference: 'Save reference', saveFailed: 'Save failed. Please try again.',
