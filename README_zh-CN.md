...
当前公开 beta：[`v0.7.2-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.2-beta)。这个版本保留搜索排序 operators、工作 queue Cancel 与 backend restart recovery，并加入 failed generation jobs 的安全 Retry。
