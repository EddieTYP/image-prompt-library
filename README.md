...
Current public beta: [`v0.7.1-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.1-beta). This release keeps prompt variables public, preserves Template indicators and generated-result cleanup, adds search sort operators, exposes queue cancellation in the work queue, and marks interrupted running generation jobs as failed after backend restarts.
