...
type TranslationKey =
  ...
  | 'deleteReference' | 'deleteReferenceConfirm' | 'selectReferences' | 'selectedReferences' | 'archiveSelectedReferences' | 'favoriteSelectedReferences' | 'tagSelectedReferences' | 'moveSelectedReferences' | 'deleteSelectedReferences' | 'deleteSelectedReferencesConfirm' | 'cancel' | 'saving' | 'saveReference' | 'saveFailed'
...
const TRANSLATIONS: Record<UiLanguage, Record<TranslationKey, string>> = {
  zh_hant: {
    ...
    deleteReference: '刪除參考', deleteReferenceConfirm: '刪除此參考？\n這會刪除 library 記錄；如果本機圖片檔案沒有被其他參考使用，也會一併刪除。', selectReferences: '選取', selectedReferences: '已選取', archiveSelectedReferences: 'Archive', favoriteSelectedReferences: 'Favorite', tagSelectedReferences: 'Tag', moveSelectedReferences: 'Move', deleteSelectedReferences: '刪除', deleteSelectedReferencesConfirm: '刪除已選取的 ${selectedItemIds.size} 個參考？\nLibrary 記錄會被刪除；未被其他參考使用的本機圖片檔案也會一併刪除。', cancel: '取消', saving: '儲存中…', saveReference: '儲存參考', saveFailed: '儲存失敗，請再試一次。',
  ...
  zh_hans: {
    ...
    deleteReference: '删除参考', deleteReferenceConfirm: '删除此参考？\n这会删除 library 记录；如果本地图片文件没有被其他参考使用，也会一并删除。', selectReferences: '选择', selectedReferences: '已选择', archiveSelectedReferences: 'Archive', favoriteSelectedReferences: 'Favorite', tagSelectedReferences: 'Tag', moveSelectedReferences: 'Move', deleteSelectedReferences: '删除', deleteSelectedReferencesConfirm: '删除已选择的 ${selectedItemIds.size} 个参考？\nLibrary 记录会被删除；未被其他参考使用的本地图片文件也会一并删除。', cancel: '取消', saving: '保存中…', saveReference: '保存参考', saveFailed: '保存失败，请再试一次。',
