...
当前公开 beta：[`v0.6.7-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.6.7-beta)。这个版本加入 detail 页删除、多选批量删除、未使用本地图片文件清理、更清楚的删除确认文字、手机选择间距调整，以及更可靠的 macOS service label handling。
