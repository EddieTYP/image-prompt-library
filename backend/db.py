...
MIGRATIONS = ["001_initial.sql", "002_image_roles.sql", "003_image_role_check.sql", "004_prompt_provenance.sql", "005_cluster_names.sql", "006_import_drafts.sql", "007_generation_jobs.sql"]
