...
当前公开 beta：[`v0.7.0-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.0-beta)。这个版本公开 prompt variables 给本地生成使用，为可复用 prompt 加上 Template 标记，并改进生成结果清理和 queue 行为。
