...
目前公開 beta：[`v0.6.8-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.6.8-beta)。這版加入 detail 頁刪除、多選批量刪除、未使用本機圖片檔案清理、更清楚的刪除確認文字、手機選取間距調整，以及更可靠的 macOS service label handling。
