...
[![Release](https://img.shields.io/github/v/tag/EddieTYP/image-prompt-library?sort=semver&label=release)](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.7-beta)
...
Current public beta: [`v0.7.7-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.7-beta). The current beta includes power-user library management with structured search filters, visible sorting, batch reference actions, local cleanup preview/apply tools, and desktop and mobile layout polish; this patch also hardens local generation with clearer provider readiness, safer stale-job recovery, live ChatGPT / Codex OAuth QA, and compact desktop/mobile generation controls.
