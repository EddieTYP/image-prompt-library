...
```bash
curl -fsSL https://raw.githubusercontent.com/EddieTYP/image-prompt-library/main/scripts/install.sh | bash -s -- --version v0.6.7-beta
image-prompt-library start
```
...
```bash
image-prompt-library update --version v0.6.7-beta
```
