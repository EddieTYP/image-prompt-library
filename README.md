...
[![Release](https://img.shields.io/github/v/tag/EddieTYP/image-prompt-library?sort=semver&label=release)](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.6-beta)
...
Current public beta: [`v0.7.6-beta`](https://github.com/EddieTYP/image-prompt-library/releases/tag/v0.7.6-beta). This patch adds power-user library management with structured search filters, visible sorting, batch reference actions, and local cleanup preview/apply tools, with desktop and mobile layout polish.
